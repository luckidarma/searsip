...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Data Master
        <small>Detail Surat Keluar</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-database"></i> Data Master</a></li>
        <li><a href="<?php echo base_url('c_seakeluar') ?>"> Surat Keluar</a></li>
      ...
      <div class="row">
        ...
        <?php foreach ($tb_suratkeluar as $data) {
        ?>
        <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group">
                <label>Nomor Arsip Bidang</label>
                <label>:</label>
                <?php echo $data->id_suratkeluar; ?>
              </div>

              <div class="form-group">
                <label>Tanggal Surat Keluar</label>
                <label>:</label>
                <?php echo date('d-m-Y', strtotime($data->tgl_suratkeluar));  ?>
              </div>

              <div class="form-group">
                <label>Nomor Surat</label>
                <label>:</label>
                <?php echo $data->nomor_suratkeluar;  ?>
              </div>
              
              <div class="form-group">
                <label>Perihal</label>
                <label>:</label>
                <?php echo $data->perihal_suratkeluar;  ?>
              </div>

              <div class="form-group">
                <label>Tujuan</label>
                <label>:</label>
                <?php echo $data->tujuan_suratkeluar;  ?>
              </div>
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <label>:</label>
                <a href="<?php echo base_url('uploads/surat_keluar/'.$data->keluar_file.''); ?>" target="_blank">Nomor Surat <?php echo $data->nomor_suratkeluar; ?></a>
              </div>
