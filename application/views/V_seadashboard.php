  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="c_seascanned">
            <i class="fa fa-envelope"></i> <span>Scanned Dokumen</span>
            <span class="pull-right-container">
            </span>
          </a>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="small-box bg-yellow">
        <div class="inner">
          <?php foreach ($countMasuk->result_array() as $dt) { ?>
             
          <h3><?php echo ($total = $dt['total']); ?></h3>
          <?php } ?>

          <p>Surat Masuk Proses</p>
        </div>
        <div class="icon">
          <i class="ion ion-stats-bars"></i>
        </div>
        <a href="<?php echo base_url('c_seadashboard/masukProses') ?>" class="small-box-footer">Lihat Detail <i class="fa fa-arrow-circle-right"></i></a>
      </div>
    </section>
    </div>
    ...
    <section class="content">
      ...
      <div class="small-box bg-blue">
        <div class="inner">
          <?php foreach ($countSelesai->result_array() as $dt) { ?>
             
          <h3><?php echo ($total = $dt['total']); ?></h3>
          <?php } ?>

          <p>Surat Masuk Selesai</p>
        </div>
        <div class="icon">
          <i class="ion ion-filing"></i>
        </div>
        <a href="<?php echo base_url('c_seadashboard/masukSelesai') ?>" class="small-box-footer">Lihat Detail <i class="fa fa-arrow-circle-right"></i></a>
      </div>
    </section>
    </div>
    ...
    <section class="content">
      ...
      <div class="small-box bg-green">
        <div class="inner">
          <?php foreach ($countTotal->result_array() as $dt) { ?>
    ...
    <section class="content">
      ...
      <div class="small-box bg-red">
        <div class="inner">
          <?php foreach ($countDocument->result_array() as $dt) { ?>
             
          <h3><?php echo ($total = $dt['total']); ?></h3>
          <?php } ?>

          <p>Document Scanned</p>
        </div>
        <div class="icon">
          <i class="ion ion-document-text"></i>
        </div>
        <a href="<?php echo base_url('c_seascanned') ?>" class="small-box-footer">Lihat Detail <i class="fa fa-arrow-circle-right"></i></a>
      </div>
    </section>
    </div>
